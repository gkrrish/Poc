...
public class CodingErrorPdfInvoiceCreator {
    ...
    public void createTableHeader(ProductTableHeader productTableHeader) {
        ...
        threeColTable1.addCell(new Cell().add(new Paragraph("Description")).setBold().setFontColor(new DeviceGray(1.0f)).setBorder(Border.NO_BORDER));
        threeColTable1.addCell(new Cell().add(new Paragraph("Quantity")).setBold().setFontColor(new DeviceGray(1.0f)).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
        threeColTable1.addCell(new Cell().add(new Paragraph("Price")).setBold().setFontColor(new DeviceGray(1.0f)).setTextAlignment(TextAlignment.RIGHT).setBorder(Border.NO_BORDER)).setMarginRight(15f);
